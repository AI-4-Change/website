...
(function(e) {
    ...
    e.fn.prettyPhoto = function(s) {
        ...
        function C() { if (isSet && settings.overlay_gallery && S(pp_img[set_position]) == "image") { itemWidth = 52 + 5;
                navWidth = settings.theme == "facebook" || settings.theme == "pp_default" ? 50 : 30;
                itemsPerPage = Math.floor((a["containerWidth"] - 100 - navWidth) / itemWidth);
                itemsPerPage = itemsPerPage < pp_img.length ? itemsPerPage : pp_img.length;
                totalPage = Math.ceil(pp_img.length / itemsPerPage) - 1; if (totalPage == 0) { navWidth = 0;
        ...
        function k(t) { if (settings.social_tools) facebook_like_link = settings.social_tools.replace("{location_href}", encodeURIComponent(location.href));
            ...
            $pp_pic_holder = e(".pp_pic_holder"), $ppt = e(".ppt"), $pp_overlay = e("div.pp_overlay"); if (isSet && settings.overlay_gallery) { currentGalleryPage = 0;
                toInject = ""; for (var n = 0; n < pp_img.length; n++) { if (!pp_img[n].match(/\b(jpg|jpeg|png|gif)\b/gi)) { classname = "default";
        ...
        e.prettyPhoto.initialize = function() { settings = s; if (settings.theme == "pp_default") settings.horizontal_padding = 16;
            ...
            pp_img = isSet ? jQuery.map(o, function(t, n) { if (e(t).attr(settings.hook).indexOf(theRel) != -1) return e(t).attr("href") }) : e.makeArray(e(this).attr("href"));
            ...
            pp_descriptions = isSet ? jQuery.map(o, function(t, n) { if (e(t).attr(settings.hook).indexOf(theRel) != -1) return e(t).attr("title") ? e(t).attr("title") : "" }) : e.makeArray(e(this).attr("title")); if (pp_img.length > settings.overlay_gallery_max) settings.overlay_gallery = false;
            set_position = jQuery.inArray(e(this).attr("href"), pp_img);
        ...
        e.prettyPhoto.open = function(t) { if (typeof settings == "undefined") { settings = s;
                pp_img = e.makeArray(arguments[0]);
            ...
            $pp_pic_holder.find(".currentTextHolder").text(set_position + 1 + settings.counter_separator_label + e(pp_img).size()); if (typeof pp_descriptions[set_position] != "undefined" && pp_descriptions[set_position] != "") { $pp_pic_holder.find(".pp_description").show().html(unescape(pp_descriptions[set_position])) } else { $pp_pic_holder.find(".pp_description").hide() }
            movie_width = parseFloat(i("width", pp_img[set_position])) ? i("width", pp_img[set_position]) : settings.default_width.toString();
            movie_height = parseFloat(i("height", pp_img[set_position])) ? i("height", pp_img[set_position]) : settings.default_height.toString();
            ...
            $pp_pic_holder.fadeIn(function() { settings.show_title && pp_titles[set_position] != "" && typeof pp_titles[set_position] != "undefined" ? $ppt.html(unescape(pp_titles[set_position])) : $ppt.html(" ");
                imgPreloader = "";
                skipInjection = false; switch (S(pp_img[set_position])) {
                    case "image":
                        imgPreloader = new Image;
                        nextImage = new Image; if (isSet && set_position < e(pp_img).size() - 1) nextImage.src = pp_img[set_position + 1];
                        prevImage = new Image; if (isSet && pp_img[set_position - 1]) prevImage.src = pp_img[set_position - 1];
                        ...
                        imgPreloader.onerror = function() { alert("Image cannot be loaded. Make sure the path is correct and image exist.");
                            e.prettyPhoto.close() };
                        imgPreloader.src = pp_img[set_position]; break;
                    case "youtube":
                        a = w(movie_width, movie_height);
                        movie_id = i("v", pp_img[set_position]); if (movie_id == "") { movie_id = pp_img[set_position].split("youtu.be/");
                        ...
                        i("rel", pp_img[set_position]) ? movie += "?rel=" + i("rel", pp_img[set_position]) : movie += "?rel=1"; if (settings.autoplay) movie += "&autoplay=1";
                    ...
                    case "vimeo":
                        a = w(movie_width, movie_height);
                        movie_id = pp_img[set_position]; var t = /http(s?):\/\/(www\.)?vimeo.com\/(\d+)/; var n = movie_id.match(t);
                    ...
                    case "quicktime":
                        ...
                        toInject = settings.quicktime_markup.replace(/{width}/g, a["width"]).replace(/{height}/g, a["height"]).replace(/{wmode}/g, settings.wmode).replace(/{path}/g, pp_img[set_position]).replace(/{autoplay}/g, settings.autoplay); break;
                    case "flash":
                        a = w(movie_width, movie_height);
                    ...
                    case "ajax":
                        ...
                        doresize = true;
                        skipInjection = true;
                        e.get(pp_img[set_position], function(e) { toInject = settings.inline_markup.replace(/{content}/g, e);
                    ...
                    case "inline":
                        myClone = e(pp_img[set_position]).clone().append('<br clear="all" />').css({ width: settings.default_width }).wrapInner('<div id="pp_full_res"><div class="pp_inline"></div></div>').appendTo(e("body")).show();
                        doresize = false;
                        a = w(e(myClone).width(), e(myClone).height());
                        doresize = true;
                        e(myClone).remove();
                        toInject = settings.inline_markup.replace(/{content}/g, e(pp_img[set_position]).html()); break } if (!imgPreloader && !skipInjection) { $pp_pic_holder.find("#pp_full_res")[0].innerHTML = toInject;
                    g() } }); return false };
        e.prettyPhoto.changePage = function(t) { currentGalleryPage = 0; if (t == "previous") { set_position--; if (set_position < 0) set_position = e(pp_img).size() - 1 } else if (t == "next") { set_position++; if (set_position > e(pp_img).size() - 1) set_position = 0 } else { set_position = t }
